...
import com.example.fusha.databinding.FragmentOrtaTestBinding
import com.example.fusha.utils.dp
import com.google.android.material.card.MaterialCardView
import java.util.Locale

class OrtaTestFragment : Fragment() {
    private val currentLessonid = 23

  private val binding by lazy { FragmentOrtaTestBinding.inflate(layoutInflater) }



    private val originalWords = listOf(
        "بُشْ", "رَشْ", "قَبْلُ", "قُلْ", "قِنْ", "زُقْ",
        "سِلْ", "سِرْ", "سَمْ", "بَسْ", "شُكْرُ", "شَرْ",
        "ثَيْبُ",  "ثَمَنْ", "ثِبْ",
        "قَصَبْ","فَصْ","صِفْ","صُمْ",
        "طَلَبْ","بَطْ","طَيْ","شَطْ","طَلْ",
    )
    ...
    private fun initLetterButtons() {
        ...
        binding.btnTekshirishNext.setOnClickListener {
            val jimid = 24
            LessonUtils.markLessonAsSeen(requireContext(),jimid)
            findNavController().navigate(R.id.action_ortaTestFragment_to_jimFragment)
        }
