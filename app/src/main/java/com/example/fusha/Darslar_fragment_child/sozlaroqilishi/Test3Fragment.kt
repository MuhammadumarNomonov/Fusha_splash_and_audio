...
import com.example.fusha.databinding.FragmentTest3Binding
import com.example.fusha.utils.dp
import com.google.android.material.card.MaterialCardView
import java.util.Locale

class Test3Fragment : Fragment() {
    private val currentLessonid = 30

    private val binding by lazy { FragmentTest3Binding.inflate(layoutInflater) }



    private val originalWords = listOf(
        "خَبْ", "جَمَلْ", "دُبْ", "دَمْ", "جَرْ", "جَمْ",
        "حِلْ", "حَىْ", "خَشَبْ", "خَبَرْ", "خَرَجْ", "خَلْ",
        "غَمْ",  "يَحْتَمِلْ", "دَبْغُِ",
        "دَهْرُ","بَغْلُ","غِلْ","غَبْ",
        "جَمْعُ","مَعَ","هُدْهُدْ","عَنْ","بِعْ",
    )
    ...
    private fun initLetterButtons() {
        ...
        binding.btnTekshirishNext.setOnClickListener {
            val dooodid = 31
            LessonUtils.markLessonAsSeen(requireContext(),dooodid)
            findNavController().navigate(R.id.action_test3Fragment_to_doodFragment)
        }
